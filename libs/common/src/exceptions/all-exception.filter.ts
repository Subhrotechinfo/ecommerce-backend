  ...
  constructor(
    ...
    if (isHttpException) {
      ...
      _.assign(errorData, {
        statusCode:
          rpcError?.statusCode ||
          ERROR_RESPONSE.INTERNAL_SERVER_ERROR.statusCode,
        message:
          rpcError?.message || ERROR_RESPONSE.INTERNAL_SERVER_ERROR.message,
        errorCode:
          rpcError.errorCode || ERROR_RESPONSE.INTERNAL_SERVER_ERROR.errorCode,
        errorService: microserviceName,
